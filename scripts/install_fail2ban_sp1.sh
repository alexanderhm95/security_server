...
IGNORE_IPS="127.0.0.1/8 ::1 10.10.0.0/24 172.26.0.0/24 190.96.96.0/21"
PUBLIC_IGNORE_IPS="127.0.0.1/8 ::1 10.10.0.0/24 172.26.0.0/24 190.96.96.0/21"
...
Opciones:
  --ignore-ips "IP1 IP2 CIDR"      IPs globales permitidas. Default: 127.0.0.1/8 ::1 10.10.0.0/24 172.26.0.0/24 190.96.96.0/21
  --public-ignore-ips "IP1 CIDR"   IPs/redes permitidas para jails Nginx. Default: 127.0.0.1/8 ::1 10.10.0.0/24 172.26.0.0/24 190.96.96.0/21
...
Ejemplo:
  sudo ./install_fail2ban_sp1.sh --public-ignore-ips "127.0.0.1/8 ::1 10.10.0.0/24 172.26.0.0/24 190.96.96.0/21"
